...
# from ..app import NationalWaterLevelForecastCanada
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_canada"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_canada.tests.tests"

        To run tests in the NationalWaterLevelForecastCanadaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_canada.tests.tests.NationalWaterLevelForecastCanadaTestCase"

        To run only the test_if_tethys_platform_is_great function in the NationalWaterLevelForecastCanadaTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_canada.tests.tests.NationalWaterLevelForecastCanadaTestCase.test_if_tethys_platform_is_great"
...
class NationalWaterLevelForecastCanadaTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(NationalWaterLevelForecastCanada)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(NationalWaterLevelForecastCanada)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/national-water-level-forecast-canada/')  # The final '/' is essential for all pages/controllers
